...
return $settings = array(
    ...
    'idp' => array(
         ...
         */
        'certFingerprint' => env('SAML2_'.$this_idp_env_id.'_IDP_FINGERPRINT', ''),

        /*
         * Sometimes it is possible that your signing and encryption will be different
         * use this instead of x509cert
         *
        'x509certMulti'=>array(
            'signing'=>array(
                0=>env('SAML2_'.$this_idp_env_id.'_IDP_x509_SIGNING',''),
            ),
            'encryption'=>array(
                0=>env('SAML2_'.$this_idp_env_id.'_IDP_x509_ENCRYPT',''),
            ),
        ),
        */
    ),
